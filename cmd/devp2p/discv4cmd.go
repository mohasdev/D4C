...
var (
	discv4Command = &cli.Command{
		...
		Subcommands: []*cli.Command{
			...
			discv4WrongFromFieldExtraDataPingCommand,
	...
	discv4WrongToFieldPingCommand = &cli.Command{
		Name:      "wrong-to-ping",
		Usage:     "Sends ping to a node with a wrong to field",
		Action:    discv4WrongToFieldPing,
		ArgsUsage: "<node> <fuzzer-name> <run> <string-to-mutate>",
		Flags:     discoveryNodeFlags,
	}

	discv4WrongFromFieldPingCommand = &cli.Command{
	...
	discv4WrongFromFieldExtraDataPingCommand = &cli.Command{
		Name:      "wrong-from-extra-data-ping",
		Usage:     "Sends ping to a node with a wrong from field and fuzzed extra data",
		Action:    discv4WrongFromFieldExtraDataPing,
		ArgsUsage: "<node> <fuzzer-name> <run> <string-to-mutate>",
		Flags:     discoveryNodeFlags,
	}
...
func discv4WrongToFieldPing(ctx *cli.Context) error {
...
func discv4WrongFromFieldExtraDataPing(ctx *cli.Context) error {
